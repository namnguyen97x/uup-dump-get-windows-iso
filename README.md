...
* `windows-11-23h2`: Windows 11 22631 (aka 23H2) Professional
* `windows-2022`: Windows Server 2022 20348 (aka 21H2) Standard

**Note:** Windows 11 24H2 edition is currently disabled due to UUP dump server availability issues.
...
./build.sh create-iso windows-11-23h2
./build.sh destroy-vm
```
